...
void SSD1306_UpdateScreen(void) {
	...
	for (m = 0; m < 8; m++) {
		...
		/* Write multi data */
		I2C_Burst_Write(&I2C1handle,SSD1306_I2C_ADDR, 0x40,SSD1306_WIDTH,&SSD1306_Buffer[SSD1306_WIDTH * m]);
	}
}
...
I2C_Burst_Write(&I2C1handle,address, reg,count+1,dt);
//HAL_I2C_Master_Transmit(SSD1306_I2C, address, dt, count+1, 10);
}


void ssd1306_I2C_Write(uint8_t address, uint8_t reg, uint8_t data) {
	I2C_Burst_Write(&I2C1handle,address,reg,1,&data);
}
