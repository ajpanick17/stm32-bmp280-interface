...
#define I2C_FLAG_TIMEOUT	(1 << I2C_SR1_TIMEOUT)    // IF SCL pulled low for > 25 ms
#define I2C_FLAG_BERR       (1 << I2C_SR1_BERR)       // SDA pulled low during invalid byte position
#define I2C_FLAG_AF			(1 << I2C_SR1_AF)       // ACKNOWLDEGE FAILURE
#define I2C_FLAG_ARLO		(1 << I2C_SR1_ARLO)       // ARBITRATION LOSS TO ANOTHER MASTER BUS
